    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-8 col-xs-offset-2 box">
                <h1><spring:message code="computers.actions.add"/></h1>
                <form:form action="${contextPath}/computers" method="POST" id="computer-form" modelAttribute="computer">
                    <fieldset>
                        <spring:bind path="name">
                            <div class="form-group ${(status.error) ? 'has-danger' : (status.value ? 'has-success' : '')}">
                                <form:label path="name" cssClass="form-control-label"><spring:message
                                        code="computers.field.name" var="fieldName"/></form:label>
                                <form:input
                                        id="computerName"
                                        path="name"
